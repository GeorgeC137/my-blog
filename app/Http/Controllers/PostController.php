...
class PostController extends Controller
{
    ...
    public function home(): View
    {
        ...
        // Most popular 5 posts based on upvotes
        $popularPosts = Post::query()
            ...
            ->groupBy(['posts.id', 'posts.title', 'posts.slug', 'posts.published_at', 'posts.thumbnail', 'posts.active', 'posts.body', 'posts.user_id', 'posts.created_at', 'posts.updated_at', 'posts.meta_title', 'posts.meta_description'])
            ->limit(5)
            ->get();

        // Recommended posts based on user upvotes (If authorized)
        $user = auth()->user();
        ...
        if ($user) {
            ...
            // Recommended posts based on user upvotes (If not authorized)
            $recommendedPosts = Post::query()
        ...
        // Recent categories with their posts
